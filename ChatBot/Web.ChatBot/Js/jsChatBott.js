...
(function () {
    ...
    $(function () {
        ...
        setTimeout(function () {
            message_side = "left";
            sendMessage('Merhaba, ben Covid Sanal Asistan. Türkçe Doğal Dil İşleme Online Yarışması AçıkHack2 kapsamında GuruTeam tarafından hazırlandım.');
        }, 1000);

        setTimeout(function () {
            message_side = "left";
            sendMessage('Bana Covid-19 hakkında cevabını öğrenmek istediğin soruları sorabilir veya dünyadaki herhangi bir ülkedeki Covid-19 ile ilgili toplam vaka sayısı, bugünkü ölüm sayısı, toplam iyileşen sayısı, vb. istatistikleri öğrenebilirsiniz. :)');
            IlkDurumKontrol = 1;
        }, 3000);
    });
}.call(this));